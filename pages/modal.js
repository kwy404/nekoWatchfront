...
class Modal extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            eps: this.props.anime.episodes != null ? this.props.anime.episodes : [],
            loading: false
        };
    ...
    render() {
        ...
        { this.props.anime == undefined &&
            ...
            <div className="load">
                ...
                <img src={"./images/background-anime/default.jpg"}></img> 
                </div>
                <div className="ep">
                <h1>Episódios</h1>
                ...
                <a href={`/assistir/${ep.idEpisode}`}>
                    ...
                    className="epe">
                        <div className="left">
                            <h1>{ index + 1}</h1>
                            <div className="photo">
                            <img src={`./images/background-anime/noimage.png`}/>
                            </div>
                        </div>
                        <div className="right">
                            <h1>Ep. {ep.ep}</h1>
